...
{
  @Nullable
  Content get(ArtifactCoordinates coordinates) throws IOException;

  void put(ArtifactCoordinates coordinates, Content content) throws IOException, InvalidContentException;

  boolean delete(ArtifactCoordinates coordinates) throws IOException;

  boolean exists(ArtifactCoordinates coordinates) throws IOException;
