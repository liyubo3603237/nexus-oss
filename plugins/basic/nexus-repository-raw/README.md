...
# Configure Repositories
    ...
    orient:insert 'into repository_configuration SET repository_name="rawproxy1", recipe_name="raw-proxy", attributes={"rawContent":{"strictContentTypeValidation":false},"proxy":{"remoteUrl":"http://www.trilemma.com/","artifactMaxAge":120}, "httpclient":{"connection":{"timeout":20000, "retries":2}}}'
